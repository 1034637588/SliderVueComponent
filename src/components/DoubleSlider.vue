...
<div class="warpper" :style="{height:`${lumpHeight}px`}">
  <div class="slider-box" :style="{backgroundColor: centerColor,height:`${height}px`}" ref="sliderBox" @touchstart="handleTouch">
    <div
      class="progress-left"
      :style="{ width: `${totalWidth*plScale+5}px`,backgroundColor:leftColor, height:`${height}px`}"
    ></div>
    <div
      class="progress-right"
      :style="{ width: `${totalWidth*prScale+5}px`, backgroundColor:rightColor, height:`${height}px`}"
    ></div>
    <div
      class="lump-left"
